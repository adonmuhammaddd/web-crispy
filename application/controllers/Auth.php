...
class Auth extends MY_Controller
{
    ...
    public function profile()
    {
        ...
        $this->template->load('backend/layout/template', 'backend/authentication/profile', $data);
    }
    ...
    public function register()
    {
        ...
        $this->template->load('backend/authentication/layout/template', 'backend/authentication/register', $data);
    }
    ...
    public function login()
    {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() && $error === true) {
                ...
                $this->template->load('backend/authentication/layout/template', 'backend/authentication/login', $data);
            }
        } else {
            $this->template->load('backend/authentication/layout/template', 'backend/authentication/login', $data);
        }
